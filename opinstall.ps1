# opinstall.ps1 - Upload & install OpenWrt .ipk packages sequentially via SSH (Windows)
# Supports: Windows 10 / 11 with PuTTY (plink/pscp)
# Languages: Simplified Chinese, Traditional Chinese, English, French
# Features:
# - Language selection
# - PuTTY auto-download (plink/pscp)
# - Password / key / pasted key auth
# - File dialog to pick .ipk
# - File dialog to pick private key
# - Real-time opkg output
# - Summary at the end
# - Cleanup temp files
